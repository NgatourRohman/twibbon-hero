...
export default function RegisterPage() {
  return (
    <div className="container-page relative grid min-h-[calc(100svh-5rem)] place-items-center overflow-hidden py-10 sm:min-h-[78vh] sm:py-16">
      <div className="absolute left-[12%] top-[16%] size-52 rounded-full bg-amber-200/30 blur-3xl" />
      <div className="absolute bottom-[12%] right-[14%] size-60 rounded-full bg-violet-300/20 blur-3xl" />
      <Card className="premium-border relative w-full max-w-md rounded-[24px] shadow-[0_35px_80px_-35px_rgba(45,35,105,.45)] sm:rounded-3xl">
        <CardContent className="p-5 sm:p-9">
          <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-gradient-to-br from-amber-100 to-white text-amber-700 shadow-clay">
